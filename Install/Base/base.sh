...
cp -rf ~/.settings/Install/Base/files/locale.gen	/etc/
locale-gen
cp -rf ~/.settings/Install/Base/files/locale.conf	/etc/
cp -rf ~/.settings/Install/Base/files/vconsole.conf	/etc/
ln -sf /usr/share/zoneinfo/Europe/Warsaw /etc/localtime
hwclock --systohc --utc 
nano /etc/hostname
nano /etc/hosts
cp -rf ~/.settings/Install/Base/files/pacman.conf	/etc/
